...
모든 빠띠는 가입하지 않아도 글 작성 외에 글 열람, 공감하기, 댓글쓰기가 가능합니다. 
...
내가 빠띠메이커인 빠띠에 들어가서, 상단의 ‘수정' 버튼을 클릭하시면 ‘메신저 열기' 영역이 있습니다. 
...
아직 서비스 내에서 바로 탈퇴가 가능하지  탈퇴를 원하시면 help@parti.xyz 메일로 보내주세요. 
